...
growth <- 'i =~ 1*wcpm_easycbmcore.wave1_r + 1*wcpm_easycbmcore.wave2_r + 1*wcpm_easycbmcore.wave3_r + 1*wcpm_easycbmcore.wave4_r
...
tbl_pred_sbac <- sbac_cv_res %>% 
  ...
  mutate(across(c(mean_CORE:std_err_Traditional), ~sprintf("%.2f", round(., 2))),
         ...
         .metric = recode(.metric,
                          ...
                          sens = "Mean Sensitivity (*SE*)",
                          spec = "Mean Specificity (*SE*)",
                          roc_auc = "Mean AUC (*SE*)",
                          sens_final = "__Final Sensitivity__",
                          spec_final = "__Final Specificity__",
